...
download_folder = "archivos_boxid"
...
if session_active:
    ...
    # Buscar los correos electrónicos ññdel remitente específico
    result, data = imap.search(None, f'(FROM "{remite}" SUBJECT "Revisar boxid")')
